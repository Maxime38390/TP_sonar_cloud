...
public class LetterDrawable extends Drawable {
    ...
    final int colorIndex = key.hashCode() % mColors.length();
    // Ensure the index is non-negative
    final int nonNegativeIndex = colorIndex >= 0 ? colorIndex : -colorIndex;
    return mColors.getColor(nonNegativeIndex, Color.BLACK);
}
}
