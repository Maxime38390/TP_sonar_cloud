...
public class SnowfallView extends View {
    ...
    void addSnow(int numFlakes) {
        for (int i = 0; i < numFlakes; i++) {
            ...
            // Utilisez nextInt() au lieu de nextFloat() pour la vitesse
            final float speed = lerp(MIN_SPEED, MAX_SPEED, snowRng.nextInt(1000)) / 1000.0f;
            final float velX = (float) (speed * cos(angle));
            final float velY = (float) (speed * sin(angle));
            // Utilisez nextInt() au lieu de nextFloat() pour la taille
            final float size = lerp(MIN_SIZE, MAX_SIZE, snowRng.nextInt(1000)) / 1000.0f;
            ...
            // Utilisez nextInt() au lieu de nextFloat() pour l'opacité
            final int alpha = (int) lerp(MIN_ALPHA, MAX_ALPHA, snowRng.nextInt(256));
